define(['jquery'], function ($) {
    ...
    var KeyboardWatcher = function () {
        ...
        this.firstPersonKeyDown = false;
        this.thirdPersonKeyDown = false;
        this.aimLeftKeyDown = false;
        this.aimRightKeyDown = false;
    ...
    KeyboardWatcher.addToProto({
        ...
        _setKeyBool: function (down, code) {
            ...
            switch (code) {
                ...
                case 16:
                case 17: this.thrustKeyDown = down; break;

                case 48: this.firstPersonKeyDown = down; break;
                case 57: this.thirdPersonKeyDown = down; break;

                case 77: this.aimLeftKeyDown = down; break;
                case 78: this.aimRightKeyDown = down; break;
